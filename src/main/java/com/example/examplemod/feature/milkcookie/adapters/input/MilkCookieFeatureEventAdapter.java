package com.example.examplemod.feature.milkcookie.adapters.input;
...
import com.example.examplemod.feature.milkcookie.application.usecase.CreateMilkCookieUseCaseImp;
...
public final class MilkCookieFeatureEventAdapter {
    ...
    public static void onAdultHorseInteract(PlayerInteractEvent.EntityInteract event) {
        ...
        player.sendSystemMessage(Component.translatable("message.trading_cells.cookie_with_milk_created"));
    }
